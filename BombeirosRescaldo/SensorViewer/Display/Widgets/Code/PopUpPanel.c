...
void PopUpPanel_init(outC_PopUpPanel *outC)
{
...
void PopUpPanel_reset(outC_PopUpPanel *outC)
{
  outC->init = kcg_true;
}
...
/* PopUpPanel */
void PopUpPanel(inC_PopUpPanel *inC, outC_PopUpPanel *outC)
{
  /* PopUpPanel */ kcg_bool tmp;
  ...
  outC->Visibility = (inC->PopUpVisible & inC->SetPopUpVisible) |
    (!((!inC->PopUpVisible & inC->SetPopUpVisible) | ((inC->ClosingCondition ==
            ON_CLICK_OUTSIDE) & !inC->MouseInside & inC->MousePressed)) & tmp);
}
