...
/**
** File C:/Users/Goku/Desktop/scade/BO/BO/BO/Simulation\Enviar_UA_1.c
**
...
A661_INTERNAL int a661_com_A661_CMD_UA_REQUEST_layer_1(buffer_el msg[], 
  outC_Enviar* scade_ctx,  extern_out_ctx_t * extern_ctx){
  int n2 = 0;
  int n1 = 0;
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_Enviar* scade_ctx, 
 ...
 int Enviar_UA_1_send(buffer_el msg[],  outC_Enviar* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
void Enviar_UA_1_receive_clear(inC_Enviar* scade_ctx, 
  extern_in_ctx_t * extern_ctx){
  scade_ctx->enviar = FALSE;
}
int Enviar_UA_1_receive(buffer_el buffer[],  int buffer_size, 
  inC_Enviar* scade_ctx,  extern_in_ctx_t * extern_ctx){
                  ...
                  case 38 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->hora_fim_atend ",
                          EvtString_byte_size,
                          sizeof(scade_ctx->hora_fim_atend));
                        a661_assign_string(scade_ctx->hora_fim_atend,
                  ...
                  case 37 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->hora_ini_atend ",
                          EvtString_byte_size,
                          sizeof(scade_ctx->hora_ini_atend));
                        a661_assign_string(scade_ctx->hora_ini_atend,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 36 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->hora_fato ",
                          EvtString_byte_size, sizeof(scade_ctx->hora_fato));
                        a661_assign_string(scade_ctx->hora_fato,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 35 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->rg ",
                          EvtString_byte_size, sizeof(scade_ctx->rg));
                        a661_assign_string(scade_ctx->rg,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 34 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->dt_fim_atend ",
                          EvtString_byte_size, sizeof(scade_ctx->dt_fim_atend));
                        a661_assign_string(scade_ctx->dt_fim_atend,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 33 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->dt_ini_atend ",
                          EvtString_byte_size, sizeof(scade_ctx->dt_ini_atend));
                        a661_assign_string(scade_ctx->dt_ini_atend,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 32 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->dt_fato ",
                          EvtString_byte_size, sizeof(scade_ctx->dt_fato));
                        a661_assign_string(scade_ctx->dt_fato,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
