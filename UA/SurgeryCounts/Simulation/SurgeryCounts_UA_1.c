...
/**
** File C:/Users/thais/projetosigac/UA/SurgeryCounts/Simulation\SurgeryCounts_UA_1.c
**
...
A661_INTERNAL int a661_com_A661_CMD_UA_REQUEST_layer_1(buffer_el msg[], 
  outC_SurgeryCounts* scade_ctx,  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[], 
 ...
 int SurgeryCounts_UA_1_send(buffer_el msg[],  outC_SurgeryCounts* scade_ctx, 
...
void SurgeryCounts_UA_1_receive_clear(inC_SurgeryCounts* scade_ctx, 
  extern_in_ctx_t * extern_ctx){
  
}
int SurgeryCounts_UA_1_receive(buffer_el buffer[],  int buffer_size, 
  inC_SurgeryCounts* scade_ctx,  extern_in_ctx_t * extern_ctx){
  int n = 0;
  int next_n = 0;
  /*  type root */
  switch (buffer[ n ]){
