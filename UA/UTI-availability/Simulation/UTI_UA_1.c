...
/**
** File C:/Users/thais/projetosigac/UA/UTI-availability/Simulation\UTI_UA_1.c
**
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_UTI* scade_ctx, 
 ...
 int UTI_UA_1_send(buffer_el msg[],  outC_UTI* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
void UTI_UA_1_receive_clear(inC_UTI* scade_ctx,  extern_in_ctx_t * extern_ctx){
...
int UTI_UA_1_receive(buffer_el buffer[],  int buffer_size,  inC_UTI* scade_ctx, 
