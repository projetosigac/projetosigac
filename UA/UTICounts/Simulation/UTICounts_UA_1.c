...
/**
** File C:/Users/thais/projetosigac/UA/UTICounts/Simulation\UTICounts_UA_1.c
**
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_UTICounts* scade_ctx, 
 ...
 int UTICounts_UA_1_send(buffer_el msg[],  outC_UTICounts* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
void UTICounts_UA_1_receive_clear(inC_UTICounts* scade_ctx, 
  extern_in_ctx_t * extern_ctx){
  
}
int UTICounts_UA_1_receive(buffer_el buffer[],  int buffer_size, 
  inC_UTICounts* scade_ctx,  extern_in_ctx_t * extern_ctx){
  int n = 0;
  int next_n = 0;
  /*  type root */
  switch (buffer[ n ]){
