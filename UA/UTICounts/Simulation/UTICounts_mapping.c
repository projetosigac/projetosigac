...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_UTICounts();
	pSimulator->m_pfnFinalizeMapping(pSimulator);
}

/****************************************************************
 ** UTICounts/ mapping function
 ****************************************************************/
void _SCSIM_Mapping_UTICounts() {
	pSimulator->m_pfnSetRoot(pSimulator, "UTICounts/", &outputs_ctx, _SCSIM_Get_UTICounts_Handle);
