#ifndef _XRAYCOUNTS_UA_1_H_
#  define _XRAYCOUNTS_UA_1_H_ 

#include "XRayCounts.h"

/**
** File XRayCounts_UA_1.h
**
...
extern int XRayCounts_UA_1_send(buffer_el msg[], outC_XRayCounts* scade_ctx,
  extern_out_ctx_t * extern_out_ctx);
extern int XRayCounts_UA_1_receive(buffer_el buffer[], int buffer_size,
  inC_XRayCounts* scade_ctx, extern_in_ctx_t * extern_in_ctx);
extern void XRayCounts_UA_1_receive_clear(inC_XRayCounts* scade_ctx,
  extern_in_ctx_t * extern_in_ctx);


#endif /* _XRAYCOUNTS_UA_1_H_ */
