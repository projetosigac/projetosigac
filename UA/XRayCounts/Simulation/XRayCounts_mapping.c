...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_XRayCounts();
	pSimulator->m_pfnFinalizeMapping(pSimulator);
}

/****************************************************************
 ** XRayCounts/ mapping function
 ****************************************************************/
void _SCSIM_Mapping_XRayCounts() {
	pSimulator->m_pfnSetRoot(pSimulator, "XRayCounts/", &outputs_ctx, _SCSIM_Get_XRayCounts_Handle);
